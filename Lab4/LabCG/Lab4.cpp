...
void setup() {
	...
	Model* model = new Model("DFiles/sphere.d.txt", color, false);
	model->loadTexture("Textures/diffuse.txt", "Textures/specular.txt", "Textures/cloud.txt", "Textures/lights.txt");
	model->scale(5);
	models.push_back(model);
